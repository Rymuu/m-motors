        ...
        <div className="flex-1 min-w-0">
          {result.data.length === 0 ? (
            <div className="bg-white rounded-2xl border border-[#E4E9F2] p-12 text-center">
              <p className="text-[#5B6B82]">Aucun véhicule ne correspond à vos critères.</p>
              <Link
                href={`/vehicles${listingType ? `?listingType=${listingType}` : ''}`}
                className="inline-flex items-center mt-4 text-sm font-semibold text-[#2563EB] hover:underline no-underline"
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6">
              {result.data.map((vehicle: Vehicle) => (
                ...
                >
                  <div className="relative h-44 bg-[#EEF3FF] overflow-hidden">
                    <img
                      src={
                        vehicle.images?.[0] ??
                  ...
                  <div className="p-4">
                    <h2 className="[font-family:var(--font-sora)] font-bold text-[#0E2A6B] text-base">
                    ...
                    <div className="flex items-center justify-between mt-3">
                      <p className="[font-family:var(--font-sora)] font-bold text-[#2563EB] text-lg">
